...
with open('/home/pi/script/pass/public_grange_b_weather_nectar', 'r') as myfile:
    public_grange_b_weather=myfile.read().replace('\n', '')

with open('/home/pi/script/pass/private_grange_b_weather_nectar', 'r') as myfile:
    private_grange_b_weather=myfile.read().replace('\n', '')
...
pht_weather = Phant(publicKey=public_grange_b_weather, fields=field_name_weather ,privateKey=private_grange_b_weather,baseUrl=nectar_address)
port_weather = 'USB VID:PID=0403:6015 SNR=DN01JRKR'
...
file_name= 'weather_grange_b_nectar.csv'
