...
```shell
pip install "git+https://github.com/hydrogeologger/pyduino.git@pylib/postprocess#egg=postprocess&subdirectory=python/lib/postprocess"

# or

pip install "postprocess @ git+https://github.com/hydrogeologger/pyduino.git@pylib/postprocess#subdirectory=python/lib/postprocess"
```
...
import pandas as pd
import postprocess
from postprocess.file_matching import FileCorrelation
