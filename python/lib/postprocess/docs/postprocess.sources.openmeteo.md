...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/openmeteo.py#L74"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
- <b>`coordinates`</b> (tuple | list): A single geographic WGS84 coordinate as a
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/openmeteo.py#L254"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/openmeteo.py#L271"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>

## <kbd>function</kbd> `extract_timeseries_dataframe`

```python
extract_timeseries_dataframe(point_data, freq)
```
...
- <b>`point_data`</b> (dict): Parsed JSON response from the Open-Meteo API.
...
- <b>`KeyError`</b>: Timeseries data for specified frequency is not present in ``point_data``.
ValueError:
    - ``point_data`` is empty.
