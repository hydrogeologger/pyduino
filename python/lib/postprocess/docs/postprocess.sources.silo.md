...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/silo.py#L102"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/silo.py#L209"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/silo.py#L244"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/silo.py#L338"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
**Returns:**
    ...
    list[dict]: A list of nearby stations, or an empty list if no stations are found.
        ...
        - ``number`` (int): SILO station number.
        - ``name`` (str): Station name.
        - ``llatitude`` (float): Latitude of the station in GDA94.
        - ``longitude`` (float): Longitude of the station in GDA94.
        - ``elevation`` (float): Station elevation in metres.
        - ``state`` (str): Australian state or territory.
        - ``distance_km`` (float): Distance from the reference station
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/silo.py#L407"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/silo.py#L54"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
...
<a href="../../../../python/lib/postprocess/src/postprocess/sources/silo.py#L76"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square" /></a>
