...
def convert_to_dataframes(data, keys=None, drop_ts=True, verbose=False):  # pylint: disable-next=line-too-long
    # type: (dict[str, list[dict[str, any]]], _Optional[tuple|list], _Optional[bool], _Optional[bool]) -> dict[str, _pd.DataFrame]
...
def convert_to_dataframe(data, keys=None, drop_ts=True, verbose=False):  # pylint: disable-next=line-too-long
    # type: (dict[str, list[dict[str, any]]], _Optional[tuple|list], _Optional[bool], _Optional[bool]) -> _pd.DataFrame
...
def add_multindex_level(df, keys, level=0, axis=1, name=None, na_rep=None, inplace=False):  # pylint: disable-next=line-too-long
    # type: (_pd.DataFrame|_pd.Series, (any|list[any]), _Optional[int], _Optional[int], _Optional[str], _Optional[any], _Optional[bool]) -> None | _pd.MultiIndex
