...
class Device():
    ...
    def delete_timeseries(self,
                          ...
                          rewriteLatestIfDeleted=False,  # type: bool|None # pylint: disable=invalid-name
        ...
        Returns:
            bool: Returns true if delete was successfull.
        ...
        base_url = _urljoin(
            self.account.url,
            "/api/plugins/telemetry/DEVICE/{}/timeseries/delete".format(
                self.device_id)
        )
        headers = {"Content-Type": "application/json",
                   "X-Authorization": "Bearer {}".format(self.account.token)}
