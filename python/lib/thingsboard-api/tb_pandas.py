...
def convert_to_dataframes(data, keys=None, drop_ts=True, verbose=False):  # pylint: disable-next=line-too-long
    # type: (dict[str, list[dict[str, _Any]]], list|tuple|set|None, _Optional[bool], _Optional[bool]) -> dict[str, _pd.DataFrame]
...
def convert_to_dataframe(data, keys=None, drop_ts=True, verbose=False):  # pylint: disable-next=line-too-long
    # type: (dict[str, list[dict[str, _Any]]], _Optional[tuple|list], _Optional[bool], _Optional[bool]) -> _pd.DataFrame
