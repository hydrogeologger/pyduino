...
def convert_to_dataframes(data, type_conversion, keys=None, drop_ts=True, verbose=False):  # pylint: disable-next=line-too-long
    # type: (dict[str, list[dict[str, _Any]]], bool|list|tuple|set|dict, _KeysView|list|tuple|set|None, bool|None, bool|None) -> dict[str, _pd.DataFrame]
...
def convert_to_dataframe(data, type_conversion, keys=None, drop_ts=True, verbose=False):  # pylint: disable-next=line-too-long
    # type: (dict[str, list[dict[str, _Any]]], bool|list|tuple|set|dict, _KeysView|list|tuple|set|None, bool|None, bool|None) -> _pd.DataFrame
...
def concat_dataframes(dataframes, sort=False, clean=True):
    # type: (dict[str, _pd.DataFrame], bool, bool|None) -> _pd.DataFrame
...
def split_dataframe(dataframe, dropna=False, clean=True):
    # type: (_pd.DataFrame, bool|None, bool|None) -> dict[str, _pd.DataFrame]
...
def add_multindex_level(df,  # type: _pd.DataFrame|_pd.Series
                        keys,  # type: _Iterable | str
                        level=0,  # type: int
                        axis=1,  # type: int|str
                        name=None,  # type:  str|None
                        na_rep=None,  # type: _Any
                        dtype=None,  # type: _PandasDtype|None
                        inplace=False  # type: bool|None
                        ):  # type: (...) -> _pd.MultiIndex|None
...
def dataframe_to_tb_timeseries(data, ts_level="ts"):  # pylint: disable-next=line-too-long
    # type: (_pd.DataFrame | dict[str,_pd.DataFrame], str|int|None) -> dict[str, list[dict]]
    ...
    Returns:
        dict[str, list[dict[str, Any]]]: Dictionary in the same format as the ThingsBoard timeseries
            telemetry response.
