...
- [`tb_rest_api.group_timeseries_by_key`](./thingsboard_api.tb_rest_api.md#function-group_timeseries_by_key): Converts timestamped records into a ThingsBoard timeseries response dictionary.
- [`tb_rest_api.group_timeseries_by_ts`](./thingsboard_api.tb_rest_api.md#function-group_timeseries_by_ts): Groups timestamped key-value readings into records by timestamp.
